...
(defun htmlize-decode-invisibility-spec (invisible)
  ;; Return t, nil, or `ellipsis', depending on how invisible text
  ;; should be inserted.
...
Return the set of faces specified by the `face' text
...
;; precedence.
;;
;; Under GNU Emacs, this returns all the faces in the `face' property
;; and all the faces in the overlays at point.
